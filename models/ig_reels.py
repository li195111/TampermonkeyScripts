...
from models.enums import (ID, AppID, BloksStickerType, CommercialityStatus,
                          Crosspost, IntegrityReviewDecision, ProductType,
                          VideoCodec)
...
class Story(IBase):
  ...
  media_compound_str: Optional[str]
...
class Item(IBase):
  ...
  story_link_stickers: Optional[List[Story]]
  story_bloks_stickers: Optional[List[StoryBloksSticker]]
  has_liked: bool
  ...
  attribution_content_url: Optional[str]
  story_feed_media: Optional[List[Story]]
